...
interface CartDrawerProps {
  ...
  isOpen: boolean;
  onClearCart?: () => void;
  onOrderSuccess?: (customerName: string) => void;
}
...
export default function CartDrawer({ cart, onUpdateQty, onRemove, onClose, isOpen, onClearCart, onOrderSuccess }: CartDrawerProps) {
